 ...
 */
public class X5CordovaInterfaceImpl implements X5CordovaInterface {
    ...
    protected X5CallbackMap permissionResultCallbacks;
    protected X5CordovaPlugin activityResultCallback;
    protected String initCallbackService;
    protected int activityResultRequestCode;
    protected boolean activityWasDestroyed = false;
    protected Bundle savedPluginState;

    public X5CordovaInterfaceImpl(Activity activity) {
        this(activity, Executors.newCachedThreadPool());
    }

    public X5CordovaInterfaceImpl(Activity activity, ExecutorService threadPool) {
        this.activity = activity;
        this.threadPool = threadPool;
        this.permissionResultCallbacks = new X5CallbackMap();
    }

    @Override
    public void startActivityForResult(X5CordovaPlugin command, Intent intent, int requestCode) {
    ...
    @Override
    public void setActivityResultCallback(X5CordovaPlugin plugin) {
     ...
     */
    public void onCordovaInit(X5PluginManager pluginManager) {
        ...
        if (savedResult != null) {
            ...
            {
                X5CoreAndroid appPlugin = (X5CoreAndroid) pluginManager.getPlugin(CoreAndroid.PLUGIN_NAME);
                if(appPlugin != null) {
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent intent) {
        X5CordovaPlugin callback = activityResultCallback;
            ...
            if (pluginManager != null) {
                ...
                if(callback != null) {
                    callback.onRestoreStateForActivityResult(savedPluginState.getBundle(callback.getServiceName()),
                            new X5ResumeCallback(callback.getServiceName(), pluginManager));
                }
            }
        }
        activityResultCallback = null;
    ...
    public void onRequestPermissionResult(int requestCode, String[] permissions,
        ...
        Pair<X5CordovaPlugin, Integer> callback = permissionResultCallbacks.getAndRemoveCallback(requestCode);
        if(callback != null) {
            callback.first.onRequestPermissionResult(callback.second, permissions, grantResults);
        }
    }

    public void requestPermission(X5CordovaPlugin plugin, int requestCode, String permission) {
        String[] permissions = new String [1];
        permissions[0] = permission;
        requestPermissions(plugin, requestCode, permissions);
    }

    public void requestPermissions(X5CordovaPlugin plugin, int requestCode, String [] permissions) {
