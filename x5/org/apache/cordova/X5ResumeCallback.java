...
public class X5ResumeCallback extends X5CallbackContext {
    private final String TAG = "CordovaResumeCallback";
    private String serviceName;
    private X5PluginManager pluginManager;

    public X5ResumeCallback(String serviceName, X5PluginManager pluginManager) {
    ...
    public void sendPluginResult(PluginResult pluginResult) {
        ...
        X5CoreAndroid appPlugin = (X5CoreAndroid) pluginManager.getPlugin(X5CoreAndroid.PLUGIN_NAME);
