 ...
 */
public interface X5CordovaWebView {
    public static final String CORDOVA_VERSION = "6.2.0-dev";

    void init(X5CordovaInterface cordova, List<X5PluginEntry> pluginEntries, CordovaPreferences preferences);
    ...
    X5CordovaResourceApi getResourceApi();
    ...
    X5PluginManager getPluginManager();
    X5CordovaWebViewEngine getEngine();
