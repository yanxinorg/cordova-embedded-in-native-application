 ...
 */
public class X5CordovaPlugin {
    public X5CordovaWebView webView;
    public X5CordovaInterface cordova;
     ...
     */
    public final void privateInitialize(String serviceName, X5CordovaInterface cordova, X5CordovaWebView webView, CordovaPreferences preferences) {
     ...
     */
    public void initialize(X5CordovaInterface cordova, X5CordovaWebView webView) {
    }
     ...
     */
    public boolean execute(String action, String rawArgs, X5CallbackContext callbackContext) throws JSONException {
     ...
     * @return                Whether the action was valid.
     */
    public boolean execute(String action, JSONArray args, X5CallbackContext callbackContext) throws JSONException {
     ...
     * @return                Whether the action was valid.
     */
    public boolean execute(String action, CordovaArgs args, X5CallbackContext callbackContext) throws JSONException {
        return false;
    }
     ...
     */
    public void onRestoreStateForActivityResult(Bundle state, X5CallbackContext callbackContext) {}
     ...
     */
    public X5CordovaResourceApi.OpenForReadResult handleOpenForRead(Uri uri) throws IOException {
     ...
     *
     */
    public boolean onReceivedHttpAuthRequest(X5CordovaWebView view, ICordovaHttpAuthHandler handler, String host, String realm) {
        return false;
    }
     ...
     *
     */
    public boolean onReceivedClientCertRequest(X5CordovaWebView view, ICordovaClientCertRequest request) {
        return false;
    }
