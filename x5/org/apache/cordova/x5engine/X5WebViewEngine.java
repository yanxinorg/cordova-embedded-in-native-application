...
import org.apache.cordova.X5CordovaBridge;
import org.apache.cordova.X5CordovaInterface;
import org.apache.cordova.CordovaPreferences;
import org.apache.cordova.X5CordovaResourceApi;
import org.apache.cordova.X5CordovaWebView;
import org.apache.cordova.X5CordovaWebViewEngine;
import org.apache.cordova.ICordovaCookieManager;
import org.apache.cordova.LOG;
import org.apache.cordova.X5NativeToJsMessageQueue;
import org.apache.cordova.X5PluginManager;
 ...
 */
public class X5WebViewEngine implements X5CordovaWebViewEngine {
    ...
    protected X5CordovaBridge bridge;
    protected Client client;
    protected X5CordovaWebView parentWebView;
    protected X5CordovaInterface cordova;
    protected X5PluginManager pluginManager;
    protected X5CordovaResourceApi resourceApi;
    protected X5NativeToJsMessageQueue nativeToJsMessageQueue;
    ...
    @Override
    public void init(X5CordovaWebView parentWebView, X5CordovaInterface cordova, Client client,
              X5CordovaResourceApi resourceApi, X5PluginManager pluginManager,
              X5NativeToJsMessageQueue nativeToJsMessageQueue) {
        ...
        nativeToJsMessageQueue.addBridgeMode(new X5NativeToJsMessageQueue.OnlineEventsBridgeMode(new X5NativeToJsMessageQueue.OnlineEventsBridgeMode.OnlineEventsBridgeModeDelegate() {
            @Override
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2)
            nativeToJsMessageQueue.addBridgeMode(new X5NativeToJsMessageQueue.EvalBridgeMode(this, cordova));
	bridge = new X5CordovaBridge(pluginManager, nativeToJsMessageQueue);
        exposeJsInterface(webView, bridge);
    }

    @Override
    public X5CordovaWebView getCordovaWebView() {
    ...
    private static void exposeJsInterface(WebView webView, X5CordovaBridge bridge) {
        if ((Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR1)) {
