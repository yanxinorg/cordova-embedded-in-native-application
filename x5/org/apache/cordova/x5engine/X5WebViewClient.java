...
import org.apache.cordova.X5CordovaClientCertRequest;
import org.apache.cordova.X5CordovaHttpAuthHandler;
...
public class X5WebViewClient extends WebViewClient {
    ...
    public void onReceivedHttpAuthRequest(WebView view, HttpAuthHandler handler, String host, String realm) {
        ...
        X5PluginManager pluginManager = this.parentEngine.pluginManager;
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
        try {
            ...
            X5CordovaResourceApi resourceApi = parentEngine.resourceApi;
            Uri origUri = Uri.parse(url);
            // Allow plugins to intercept WebView requests.
            Uri remappedUri = resourceApi.remapUri(origUri);

            if (!origUri.equals(remappedUri) || needsSpecialsInAssetUrlFix(origUri) || needsKitKatContentUrlFix(origUri)) {
                X5CordovaResourceApi.OpenForReadResult result = resourceApi.openForRead(remappedUri, true);
    ...
    private static boolean needsSpecialsInAssetUrlFix(Uri uri) {
        if (X5CordovaResourceApi.getUriType(uri) != X5CordovaResourceApi.URI_TYPE_ASSET) {
            return false;
        }
