 ...
 */
public class X5CallbackMap {
    private int currentCallbackId = 0;
    private SparseArray<Pair<X5CordovaPlugin, Integer>> callbacks;

    public X5CallbackMap() {
        this.callbacks = new SparseArray<Pair<X5CordovaPlugin, Integer>>();
    }
     ...
     */
    public synchronized int registerCallback(X5CordovaPlugin receiver, int requestCode) {
        int mappedId = this.currentCallbackId++;
        callbacks.put(mappedId, new Pair<X5CordovaPlugin, Integer>(receiver, requestCode));
        return mappedId;
    }
     ...
     *                      given mappedCode
     */
    public synchronized Pair<X5CordovaPlugin, Integer> getAndRemoveCallback(int mappedId) {
        Pair<X5CordovaPlugin, Integer> callback = callbacks.get(mappedId);
