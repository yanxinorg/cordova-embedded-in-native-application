 ...
 */
public class X5NativeToJsMessageQueue {
    ...
    public static abstract class BridgeMode {
        public abstract void onNativeToJsMessageAvailable(X5NativeToJsMessageQueue queue);
        public void notifyOfFlush(X5NativeToJsMessageQueue queue, boolean fromOnlineEvent) {}
        public void reset() {}
    }

    /** Uses JS polls for messages on a timer.. */
    public static class NoOpBridgeMode extends BridgeMode {
        @Override public void onNativeToJsMessageAvailable(X5NativeToJsMessageQueue queue) {
        }
    }

    /** Uses webView.loadUrl("javascript:") to execute messages. */
    public static class LoadUrlBridgeMode extends BridgeMode {
        private final X5CordovaWebViewEngine engine;
        private final X5CordovaInterface cordova;

        public LoadUrlBridgeMode(X5CordovaWebViewEngine engine, X5CordovaInterface cordova) {
            this.engine = engine;
            this.cordova = cordova;
        }

        @Override
        public void onNativeToJsMessageAvailable(final X5NativeToJsMessageQueue queue) {
    ...
    public static class OnlineEventsBridgeMode extends BridgeMode {
        ...
        @Override
        public void notifyOfFlush(final X5NativeToJsMessageQueue queue, boolean fromOnlineEvent) {
    ...
    public static class EvalBridgeMode extends BridgeMode {
        ...
        public EvalBridgeMode(X5CordovaWebViewEngine engine, X5CordovaInterface cordova) {
            this.engine = engine;
            this.cordova = cordova;
        }
