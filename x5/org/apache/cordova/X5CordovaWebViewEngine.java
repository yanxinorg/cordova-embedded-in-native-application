 ...
 */
public interface X5CordovaWebViewEngine {
    void init(X5CordovaWebView parentWebView, X5CordovaInterface cordova, Client client,
              X5CordovaResourceApi resourceApi, X5PluginManager pluginManager,
              X5NativeToJsMessageQueue nativeToJsMessageQueue);

    X5CordovaWebView getCordovaWebView();
    ...
    /**
     * Contains methods that an org.engine uses to communicate with the parent CordovaWebView.
